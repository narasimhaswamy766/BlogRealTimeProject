...
send_mail('Hello', 'Very imp msg....','yarragollanarasimhaswamy@gmail.com',['yarragollanarasimhaswamy@gmail.com','sivakumarreddyjanke@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'yarragollanasimhaswamy@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
